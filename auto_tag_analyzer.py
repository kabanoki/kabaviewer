...
class AutoTagAnalyzer:
    ...
    def get_default_mapping_rules(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            # 髪関連 - ポニーテール
            "ponytail": ["ポニーテール"],
            "high ponytail": ["ハイポニー","ポニーテール"],
            "low ponytail": ["ローポニー","ポニーテール"],
            "side ponytail": ["サイドポニー","ポニーテール"],
            "braided ponytail": ["編み込みポニー","ポニーテール"],
            
            # 髪関連 - ツインテール
            "short twin tails": ["ショートツイン","ツインテール"],
            "high twin tails": ["ハイツイン","ツインテール"],
            "low twin tails": ["ローツイン","ツインテール"],
            "side twin tails": ["サイドツイン","ツインテール"],
            "twin tails": ["ツインテール"],
            "twintails": ["ツインテール"],
            "short twintails": ["ツインテール","ツインテール"],
            "high twintails": ["ツインテール","ツインテール"],
            "low twintails": ["ツインテール","ツインテール"],
            "side twintails": ["ツインテール","ツインテール"],
            "pigtails": ["おさげ"],
            ...
            "low bun": ["ローバン","お団子"],
            "side bun": ["サイドバン","お団子"],
            "double bun": ["ダブルバン","お団子"],
            "braided bun": ["編み込みバン","お団子"],
            
            # 髪関連 - 編み込み
            "low-braided": ["低い位置で結んだ長い三つ編み","編み込み"],
            "crown braid": ["クラウンブレイド","編み込み"],
            "french braid": ["フレンチブレイド","編み込み"],
            "single braid": ["三つ編み","編み込み"],
            "twin braids": ["三つ編みツインテール","編み込み"],
            "quad braids": ["四つ編み","編み込み"],
            "side braids": ["両サイドに編み込み","編み込み"],
            "side braid": ["サイドブレイド","編み込み"],
            "braided hair rings": ["編み込みリング","編み込み"],
            "braid": ["編み込み"],
            ...
            # 髪関連 - 特殊部位
            "ahoge": ["アホ毛"],
            "dyed ahoge": ["染めアホ毛","アホ毛"],
            "heart ahoge": ["ハートアホ毛","アホ毛"],
            "ahoge wag": ["動くアホ毛","アホ毛"],
            "antenna hair": ["アンテナヘア"],
            "sidelocks": ["もみあげ"],
